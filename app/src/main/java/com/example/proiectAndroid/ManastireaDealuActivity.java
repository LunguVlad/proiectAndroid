...
public class ManastireaDealuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manastirea_dealu);
        ...
        editTextDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                datePicker = new DatePickerDialog(ManastireaDealuActivity.this,
    ...
    private  class InsertAppointmentAsyncTask extends AsyncTask<Void, Void, Integer> {
        ...
        protected void onPostExecute(Integer agentsCount) {
            Toast.makeText(ManastireaDealuActivity.this, "APPOINTMENT CREATED!", Toast.LENGTH_SHORT).show();
